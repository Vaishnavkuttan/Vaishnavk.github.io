...
const BentoCardGrid: React.FC<{
    ...
    <div
        className="bento-section grid gap-6 p-4 w-full max-w-[1200px] mx-auto select-none relative"
    ...
    return (
        ...
        `}
            ...
            <BentoCardGrid gridRef={gridRef}>
                <div className="card-responsive grid gap-6 grid-cols-1 md:grid-cols-2 lg:grid-cols-4 auto-rows-[150px] w-full">
                    {cardData.map((card, index) => {
                        ...
                        const Icon = {
                            'robot': PiRobot,
                            'cloud': PiCloud,
                            'git-branch': PiGitBranch,
                            'bug-beetle': PiBugBeetle,
                            'device-mobile': PiDeviceMobile,
                            'webhooks-logo': PiWebhooksLogo,
                            'brain': PiBrain,
                            'infinity': PiInfinity
                        }[card.icon || ''] || null;
                        ...
                        if (enableStars) {
                            return (
                                ...
                                >
                                    ...
                                    {card.description && (
                                        <div className="card__content flex flex-col relative text-text-secondary mt-2 text-center">
