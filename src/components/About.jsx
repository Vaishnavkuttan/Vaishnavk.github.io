...
const About = () => {
    ...
    const stats = [
        { label: 'Years Experience', value: '6+', icon: ChartLineUp },
        { label: 'Companies', value: '3', icon: Users },
        { label: 'Automation', value: 'Expert', icon: Lightning },
    ];
        ...
        <Section id="about" title="About Me" subtitle="A brief introduction to my professional journey.">
            <div className="grid md:grid-cols-3 gap-12 items-center">
                ...
                <div className="flex flex-col gap-4">
                    {stats.map((stat, idx) => (
                        <div key={idx} className="glass p-6 rounded-2xl flex items-center gap-4 hover:bg-white/5 transition-colors border border-glass-border">
